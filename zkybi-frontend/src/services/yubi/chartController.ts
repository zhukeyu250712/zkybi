...
/** genChartByOpenAi POST /api/chart/gen/openai */
export async function genChartByOpenAiUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByOpenAiUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseOpenAIResponse_>('/api/chart/gen/openai', {
    method: 'POST',
    params: {
      ...params,
    },
